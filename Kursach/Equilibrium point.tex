...
\begin{document}
    ...
    % Поле направлений для $ \dot x_1 $ (рис. \refeq{fig:dirFields_11}):

    % \begin{itemize}
    %     \setlength\itemsep{0.3em}
    %     \item В первой области $ \dot x_1 > 0 $.
    %     \item Во второй области $ \dot x_1 > 0 $.
    %     \item В третьей области $ \dot x_1 < 0 $.
    %     \item В четвертой области $ \dot x_1 < 0 $.
    % \end{itemize}

    % \pagebreak

    % Поле направлений для $ \dot x_2 $ (рис. \refeq{fig:dirFields_12}):

    % \begin{itemize}
    %     \setlength\itemsep{0.3em}
    %     \item В первой области $ \dot x_2 > 0 $.
    %     \item Во второй области $ \dot x_2 < 0 $.
    %     \item В третьей области $ \dot x_2 < 0 $.
    %     \item В четвертой области $ \dot x_2 > 0 $.
    % \end{itemize}
